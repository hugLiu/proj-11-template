...
namespace Jurassic.CommonModels.ModelBase
{
        ...
        where TEntity : class, IId<Int32>
    {
        ...
        public LangDataMapper()
        {
            ...
            var expm2t = Mapper.CreateMap<TModel, TEntity>();
            var expt2m = Mapper.CreateMap<TEntity, TModel>();
            if (_converter != null)
            {
            ...
            else
            {
                ...
                {
                    if (r.Attr.EntityType != null && Mapper.FindTypeMapFor(r.ModelType, r.Attr.EntityType) == null)
                    {
                        Mapper.CreateMap(r.Attr.EntityType, r.ModelType);
                        Mapper.CreateMap(r.ModelType, r.Attr.EntityType);
                    }
