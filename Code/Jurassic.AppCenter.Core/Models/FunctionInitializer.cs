...
namespace Jurassic.AppCenter.Models
{
    ...
    public class FunctionInitializer
    {
        ...
        /// </summary>
        public FunctionInitializer(DataManager<AppFunction> functionMgr)
        {
            mFunctionMgr = functionMgr;
        ...
        public void InitFunctions(IEnumerable<string> arrPaths)
        {
            ...
            InitFunctions(allAsses);
        }

        /// <summary>
        /// 根据程序集列表，反射生成系统功能列表
        /// </summary>
        /// <param name="allAsses">程序集列表</param>
        public void InitFunctions(IList<Assembly> allAsses)
        {
