...
namespace Jurassic.AppCenter
{
    ...
    public class AppFunction : IIdNameParentId<string>
    {
      ...
      //  public string IdPath { get; set; }
        ...
        /// <summary>
        /// 使用功能要输入的参数字典，键是参数名，值可以是正则表达式，表示参数匹配的模式，也可以是常量
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            {
                p = "(" + String.Join(", ", Arguments.Select(pe => pe.Key)) + ")";
            }
        ...
        public string PMark
        {
            ...
            set
            {
                ...
                var ps = new StringSpliter(value, "\n", "=");
                Arguments = ps.ToDictionary();
            }
        }
        /// <summary>
        /// 判断两个功能点是否实质上等价
        ...
        public bool IsTheSame(AppFunction other)
        {
            return other.ActionName == ActionName
                ...
                && other.Arguments.Count == Arguments.Count
                && other.Arguments.Except(Arguments).Count() == 0
